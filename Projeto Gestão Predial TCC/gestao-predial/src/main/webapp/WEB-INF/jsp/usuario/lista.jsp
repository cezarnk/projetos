...
<small>Gerenciamento de login e senha dos usuários do sistema</small>
</h2>
<hr>
<br>


<button class="btn btn-primary btn-sm" onclick="location.href='${linkTo[UsuarioController].form()}'">
<span class="glyphicon glyphicon-plus" aria-hidden="true" style="color:#5cb85c"></span> &nbsp
Criar Novo Usuário
</button>
<br>
<br>
