...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <img src="<c:url value='/resources/img/debian.png'/>" width="100%"  alt="Debian">
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <br>
    <img src="<c:url value='/resources/img/apache_tomcat.png'/>" width="100%"  alt="Tomcat">
    <br>
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <img src="<c:url value='/resources/img/mysql.png'/>" width="100%" height="110px" alt="MySQL">
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <img src="<c:url value='/resources/img/java.png'/>" width="100%" height="110px" alt="JAVA">
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <img src="<c:url value='/resources/img/hibernate.png'/>" width="100%" height="110px" alt="Hibernate">
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <img src="<c:url value='/resources/img/jquery1.png'/>" width="100%" height="70px" alt="JQuery">
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <img src="<c:url value='/resources/img/bootstrap1.png'/>" width="100%" height="70px" alt="MySQL">
  </div>
